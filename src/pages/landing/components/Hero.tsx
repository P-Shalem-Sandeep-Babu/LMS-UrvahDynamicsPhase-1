  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 md:px-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 mb-8 rounded-none">
        ...
        <motion.h1 
          className="text-5xl md:text-8xl font-black italic tracking-tighter uppercase leading-[0.9] text-white mb-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.1 }}
        >
          Evolution of <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#ffc048]">Digital Learning</span>
        </motion.h1>

        <motion.p 
          className="text-lg md:text-xl text-white/50 max-w-2xl mb-10 font-mono tracking-tight"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link to="/dashboard" className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-primary text-black text-xs font-black uppercase tracking-widest transition-all hover:bg-white hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
            Deploy Architecture <ChevronRight className="w-4 h-4" />
          </Link>
          <Link to="/coding" className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-transparent border border-white/20 text-white text-xs font-black uppercase tracking-widest hover:bg-white/5 transition-all">
      ...
      <motion.div 
        className="mt-24 relative border border-white/10 bg-[#080808]"
      ...
      >
        ...
        <div className="p-4 border-b border-white/10 flex items-center justify-between bg-black">
          ...
          <div className="text-[10px] font-mono text-white/40 uppercase tracking-widest">dashboard_preview.tsx</div>
        </div>
