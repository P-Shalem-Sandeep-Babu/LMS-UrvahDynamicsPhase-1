  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-4">
        <div className="bg-white/5 border border-white/10 p-4 relative group hover:border-primary/50 transition-colors cursor-pointer">
          ...
          <div className="flex gap-3 mb-2">
            <Code2 className="w-4 h-4 text-white/40 mt-0.5" />
        ...
        <div className="bg-white/5 border border-white/10 p-4 relative group hover:border-blue-500/50 transition-colors cursor-pointer">
          ...
          <div className="flex gap-3 mb-2">
            <Sparkles className="w-4 h-4 text-white/40 mt-0.5" />
            <p className="text-xs font-mono text-white/70 leading-relaxed">
      ...
      <button className="w-full mt-4 py-3 border border-white/10 bg-white/[0.02] hover:bg-white/5 text-[10px] font-black uppercase tracking-widest text-white transition-colors flex items-center justify-center gap-2">
