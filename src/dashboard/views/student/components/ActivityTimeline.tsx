...
export const ActivityTimeline = () => {
  const events = [
    ...
    {
      type: "review",
      text: "AI Peer Review completed with score 94/100",
      time: "5 hrs ago",
      icon: CheckCircle2,
        ...
        {events.map((event, i) => (
          <div key={i} className="flex gap-4 group">
            <div className="flex flex-col items-center">
              <div className="w-8 h-8 rounded-full border border-white/10 bg-white/5 flex items-center justify-center group-hover:border-white/30 transition-colors">
