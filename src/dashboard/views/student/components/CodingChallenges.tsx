  ...
  return (
    ...
    >
      ...
      <div className="flex-1 grid md:grid-cols-2 gap-6">
        {/* Next Challenge */}
        <div className="border border-border bg-white/[0.02] p-6 flex flex-col">
          <div className="flex justify-between items-start mb-4">
            <div className="p-2 bg-primary/10 border border-primary/20">
              <Crosshair className="w-4 h-4 text-primary" />
            </div>
            <span className="text-[10px] uppercase font-mono tracking-widest text-muted-foreground border border-border px-2 py-0.5 bg-background">
              Daily Kata
            </span>
          </div>
          ...
          <p className="text-xs font-mono text-muted-foreground mb-6 flex-1 line-clamp-3">
          ...
          <div className="flex gap-4">
            ...
            <div className="text-[10px] font-mono text-muted-foreground/80 uppercase">
              Array, Math
            </div>
          </div>
          <Link
            to="/coding"
            className="mt-6 w-full text-center py-2 bg-primary text-black text-[10px] font-black uppercase tracking-widest hover:bg-foreground transition-colors"
          >
            Deploy Environment
          </Link>
        </div>
        ...
        {/* Global Contest */}
        <div className="border border-border bg-white/[0.02] p-6 flex flex-col relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex justify-between items-start mb-4">
              <div className="p-2 bg-foreground/10 border border-border/80">
            ...
            <p className="text-xs font-mono text-muted-foreground mb-6 flex-1">
              Compete with 5,000+ engineers globally. Top 100 get fast-tracked
              for enterprise placements. Prove your optimization skills.
            </p>
            <div className="text-[10px] font-mono font-bold text-foreground mb-4">
              Ends in: <span className="text-red-500">12:45:30</span>
            </div>
            <Link
              to="/leaderboard"
              className="mt-auto w-full text-center py-2 border border-border/80 text-foreground text-[10px] font-black uppercase tracking-widest hover:bg-foreground/5 transition-colors"
            >
