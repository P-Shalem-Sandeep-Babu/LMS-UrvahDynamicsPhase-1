    ...
    >
      ...
      <div className="space-y-4">
        {contests.map((contest, i) => (
          <div
            key={i}
            className="border border-white/10 bg-white/[0.02] p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 group hover:border-white/20 transition-colors"
          >
            <div>
              ...
              <div className="flex items-center gap-6 text-[10px] font-mono text-white/50 uppercase tracking-widest">
            ...
            <div className="flex flex-col md:items-end gap-2">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-1.5 border border-white/20 text-[9px] font-bold uppercase tracking-widest text-white hover:bg-white/10 transition-colors">
                  Manage
                </button>
                <button className="px-3 py-1.5 bg-primary text-[9px] font-bold uppercase tracking-widest text-black hover:bg-white transition-colors">
                  Live Ranks
                </button>
              </div>
            </div>
